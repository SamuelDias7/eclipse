		...
		try {
			...
			while(rs.next()) {
				...
				int ano = rs.getInt("ano");
				   ...
				   // cria as opções do diálogo
		        Object[] options = {"OK", "Sair"};

		        // exibe o diálogo e recebe o índice da opção escolhida
		        int selectedOption = JOptionPane.showOptionDialog(null, "Escolha uma opção:", "Exemplo de diálogo", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[0]);
				...
				JOptionPane.showMessageDialog(null, d + "°" +  " Cadastro- " + "Nome:" + nome + " Livro:" + livro + " Autor:" + autor + " Ano:" + ano);
				
				System.out.println( d + "°" +  " Cadastro- " + "Nome:" + nome + " Livro:" + livro + " Autor:" + autor + " Ano:" + ano);
				d++;				
